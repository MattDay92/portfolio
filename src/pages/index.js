...
import Thumbnail from '/public/Portfolio_Thumbnail.png'
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content='Matt Day | Portfolio'/>
        <meta property="og:image" content={Thumbnail}/>
        <meta property="og:description" content='Matt Day is a full-stack software engineer from Indianapolis, IN.'/>
